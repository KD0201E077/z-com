...
export default function ProfileFollowButton({ userId, followed }: Props) {
  ...
  const onFollow: MouseEventHandler<HTMLButtonElement> = (e) => {
    ...
    console.log("follow", followed, userId);
    if (followed) {
  ...
  return (
    <button
      onClick={onFollow}
      className={clsx(style.followButton, followed && style.followed)}
    >
      {followed ? "언팔로우" : "팔로우"}
    </button>
  );
